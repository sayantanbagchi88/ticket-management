...
<form name="login_viewer_id.php" method="post" id="id1" action="login_viewer_pro.php">
<br><br>
...
<tr><td colspan=2>&nbsp;</td></tr>
  <tr>
    <td><font color="brown"><b>VIEWER'S ID</b></font></td>
    <td><input type="text" name="viewer_id" value=""></td>
  </tr>
  <tr>
