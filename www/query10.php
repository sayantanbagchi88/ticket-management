...
<BODY bgcolor="2cc2e5" text="blue">
<DIV ALIGN="CENTER">
<FONT color=blue>
<h2><u>TICKET INFORMATION VIEW PAGE</u></h2></FONT>
...
$result1 = mysql_query("select * from pending_tracker where pending_tracker.ticket_no='$ticket_no' order by date_time;");
...
print 	"<A HREF='login.php'><FONT color=blue size='2'> Home | </A>
	 <A HREF='associate_view.php'><FONT color=blue size='2'> Back | </A>
